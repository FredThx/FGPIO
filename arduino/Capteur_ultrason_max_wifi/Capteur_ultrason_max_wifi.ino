...
int port = 80;
String chaine_send_data = "GET /tempeDB/index.php?table=mesures&capteur=CuveFuel&temperature=%distance%"; //%distance% sera remplace par la valeur
...
//L'émetteur radio 433 mhz est branché au pin 2 de l'atmega
