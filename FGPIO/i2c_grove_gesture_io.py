...
####################################
'''
# Gestion des modules Grove-Gesture via i2c
#
#
# AUTEUR : FredThx
#			largement inspiré de https://github.com/DexterInd/GrovePi/tree/master/Software/Python/grove_gesture_sensor
#
# Projet : rpiduino_io
#
'''
...
class i2c_grove_gesture_io(i2c_device_io, digital_input_device_io):
	""" Module Grove-Gesture branché en série i2C
			Utilise smbus
	"""
	...
	def init(self):
		...
		if data0 != 0x20  :#or data1 <> 0x76:
			logging.error("Error with sensor")
		if data0 == 0x20:
			logging.info("wake-up finish.")
